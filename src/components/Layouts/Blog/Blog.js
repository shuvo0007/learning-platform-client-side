  ...
  return (
    <>
      ...
      <div className="md:text-3xl h-screen mx-10">
        <h2 className="md:text-4xl sm:text-3xl font-bold text-blue-500 md:m-5 md:text-center text-left mt-10">
          Blog Question
        </h2>
        <hr />
        <ol className="text-left mt-5">
          <li className="font-bold text-black">
            1. What is cors?
            <p className="pl-8 font-normal text-gray-700 text-justify">
              <span className="text-green-600">Ans:</span> Cross-origin resource
              sharing (CORS) is a browser mechanism which enables controlled
              access to resources located outside of a given domain. It extends
              and adds flexibility to the same-origin policy (SOP). However, it
              also provides potential for cross-domain attacks, if a website's
          ...
          <li className="font-bold text-black">
            ...
            <p className="pl-8 font-normal text-gray-700 text-justify">
              <span className="text-green-600">Ans:</span> The Firebase Realtime
          ...
          <li className="font-bold text-black">
            ...
            <p className="pl-8 font-normal text-gray-700 text-justify">
              <span className="text-green-600">Ans:</span> The private route
          ...
          <li className="font-bold text-black">
            ...
            <p className="pl-8 font-normal text-gray-700 text-justify">
              <span className="text-green-600">Ans:</span> Node.js is an
              open-source, cross-platform, back-end JavaScript runtime
              environment that runs on a JavaScript Engine and executes
